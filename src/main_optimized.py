...
class BackgroundRemovalThread(QThread):
    ...
    def __init__(self, input_path):
        ...
        self.remover = BackgroundRemoverV12Bulletproof()  # Create instance here
...
def main():
    ...
    # Handle help and other command line options
    if len(sys.argv) >= 2:
        arg = sys.argv[1]
        if arg in ['--help', '-h', '/help', '/?']:
            print("Background Remover - AI-powered background removal tool")
            print("")
            print("Usage:")
            print("  BackgroundRemover.exe [image_path]")
            print("  BackgroundRemover.exe --help")
            print("")
            print("Arguments:")
            ...
            print("")
            print("If no image path is provided, a file dialog will open.")
            return
